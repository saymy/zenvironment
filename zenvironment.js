/**
 * zenvironment 1.0.0 
 * Copyright 2015-04-8 @zouchunbo(邹春波)
 * mail: 122279907@qq.com
 * rely: none  
 * Released on: 2015-04-8
 */

(function () {
	"use strict";//严格模式
	var zenvironment=function(){
		var base=function(){
			var _x = navigator;
			if(_x){				
				return {
			...
			if(_baseusheader){
				var _client = function(){
						...
						if (window.opera){
							...
							var _isIE9 = _sUserAgent.indexOf("msie 9") > -1
							if(_isIE8){
							    _browser._ver = "8";
								_browser._ie = "IE";
							}else if(_isIE7){
    ...
    window.zenvironment = zenvironment;    
})();

/*===========================
zenvironment AMD Export
===========================*/
if (typeof(module) !== 'undefined')
{
    module.exports = window.zenvironment;
}
else if (typeof define === 'function' && define.amd) {
    define([], function() {
        'use strict';
        return window.zenvironment;        
    });
}